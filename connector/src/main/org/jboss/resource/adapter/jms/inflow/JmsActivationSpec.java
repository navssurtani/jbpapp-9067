...
public class JmsActivationSpec implements ActivationSpec
{
   ...
   /** Prefer factoryRef over Queue/TopicFactoryRef **/
   private boolean preferFactoryRef = false;    
   ...
   /**
    * @return Return the preferFactoryRef flag
    */
   public boolean getPreferFactoryRef()
   {
	   return preferFactoryRef;	   
   }
   /**
    * @param prefer True to prefer FactoryRef over Queue/TopicFactoryRef; otherwise false.
    */
   public void setPreferFactoryRef(boolean prefer)
   {
	   this.preferFactoryRef = prefer;	   
   }
