...
public class GlobalDiscoveryDisableTestCase extends JBossClusteredTestCase
{
   ...
   {
      return getDeploySetup(HAJndiAutoDiscoveryTestCase.class, "naming-util.war");
   }
      ...
      throws Exception
   {
      ...
      NamingUtil.createRemoteTestJNDIBinding("/", LOCAL2_KEY, LOCAL2_VALUE, NamingUtil.extractHostnameFromUrl(NODE1_JNDI), false);
      
      // bind to node0 using HA-JNDI
      NamingUtil.createRemoteTestJNDIBinding("/", JNDI_KEY4, JNDI_VALUE4, NamingUtil.extractHostnameFromUrl(NODE0_HAJNDI), true);
     
      //create context with AutoDiscovery disabled via global sys property
      Context naming = getAutoDiscoveryContext(false, false);
