      ...
      extends HAJndiTestBase      
{
   ...
   {
      return getDeploySetup(HAJndiTestCase.class, "cross-server.jar,naming-util.war");
   }
      ...
      throws Exception
   {
      ...
      // create subcontexts
      NamingUtil.createRemoteTestJNDIBinding(SUBCON1 + "/" + SUBCON1A, SUB1A_KEY, SUB1A_VALUE, NamingUtil.extractHostnameFromUrl(NODE0_HAJNDI), true);
      NamingUtil.createRemoteTestJNDIBinding(SUBCON2, SUB2_KEY, SUB2_VALUE, NamingUtil.extractHostnameFromUrl(NODE0_HAJNDI), true);
      NamingUtil.createRemoteTestJNDIBinding(SUBCON1, SUB1_KEY, SUB1_VALUE, NamingUtil.extractHostnameFromUrl(NODE0_HAJNDI), true);
      
      
      // lookup bindings using HA-JNDI on Node0 - should succeed
      Context naming = getContext(NODE0_HAJNDI);
      Context sub1 = (Context)lookup(naming, SUBCON1, true);  
      ...
      naming = getContext(NODE1_HAJNDI);
      Context sub2 = (Context)lookup(naming, SUBCON2, true);
      ...
      Context sub1a = (Context)lookup(naming, SUBCON1 + "/" + SUBCON1A, true);
