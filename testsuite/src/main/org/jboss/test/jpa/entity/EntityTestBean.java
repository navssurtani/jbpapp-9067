...
public class EntityTestBean implements EntityTest
{
   ...
   public FieldFlight createFieldFlight(final long id, final String name, final String companyName)
   {
      final FieldFlight fieldFlight = new FieldFlight();
      fieldFlight.setId(id);
      fieldFlight.setName(name);
   ...
   {
      // flight #1 is created in and used another test
      FieldFlight firstOne = fieldFindFlightById(new Long(3));
      if (firstOne == null)
         throw new IllegalStateException("Flight #3 could not be found");
